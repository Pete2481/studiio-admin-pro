...
INSERT INTO "new_bookings" ("address", "clientId", "createdAt", "createdBy", "durationM", "end", "id", "notes", "start", "status", "tenantId", "title", "updatedAt") SELECT "address", "clientId", "createdAt", "createdBy", "durationM", "end", "id", "notes", "start", "status", "tenantId", "title", "updatedAt" FROM "bookings";
DROP TABLE "bookings";
