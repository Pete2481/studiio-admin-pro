                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-4 border-b border-gray-200">
                        <div className="flex items-center justify-between">
                            <div
                                className={clsx("transition-opacity duration-300", isExpanded ? "opacity-100" : "opacity-0 w-0 overflow-hidden")}>
                                ...
                                <div key={item.href}>
                                    {hasSubmenu ? (
                                        ...
                                        >
                                            ...
                                            <span
                                                className={clsx("flex-1 transition-opacity duration-300", isExpanded ? "opacity-100" : "opacity-0 w-0 overflow-hidden")}>{item.label}</span>
                                            <ChevronDown
                                                size={16}
                                                className={clsx(
                                    ...
                                    {hasSubmenu && isSubmenuExpanded && (
                                        <div
                                            className={clsx("ml-6 mt-1 space-y-1 transition-all duration-300", isExpanded ? "opacity-100" : "opacity-0 h-0 overflow-hidden")}>
                                            {item.submenu?.map((subItem) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            className={clsx("transition-opacity duration-300", isExpanded ? "opacity-100" : "opacity-0 w-0 overflow-hidden")}>{subItem.label}</span>
                                                    </Link>
                                                );
                                            })}
                                        </div>
                    ...
                    <div className="p-4 border-t border-gray-200">
                        <button
                            ...
                            className="flex items-center gap-3 w-full px-3 py-2 text-sm text-slate-700 hover:bg-[var(--accent-hover)] rounded-xl transition-all duration-300">
                            <LogOut size={18} className="flex-shrink-0"/>
                            <span
                                className={clsx("transition-opacity duration-300", isExpanded ? "opacity-100" : "opacity-0 w-0 overflow-hidden")}>Logout</span>
                        </button>
                    </div>
                </div>
            </div>
